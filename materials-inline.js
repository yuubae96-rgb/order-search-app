...
(function(){
  const CATALOG={
    '金属板':{
      ...
      'ステンレス':{specs:['SUS304','SUS430','SUS316'],thickness:['0.3','0.5','0.8','1.0','1.5','2.0'],purchase:['1000×2000板','1000×1000板','500×1000板'],unit:'枚'},
      '真鍮':{specs:['C2801P'],thickness:['0.3','0.5','0.8','1.0','1.5','2.0'],purchase:['1000×2000板','1000×1000板','500×1000板'],unit:'枚'}
    },
    '樹脂板・フィルム':{
